import numpy as np
from originallearnspngp import Mixture, Separator, GPMixture, Color
import gc
import torch
import gpytorch
    ...
    def predict(self, X_s, label_y):
        ...
        with torch.no_grad(), gpytorch.settings.fast_pred_var():
            ...
            for x_batch, y_batch in test_loader:
                lls.append(mll(self.model(x_batch),y_batch).item())
                # lls.append(ExactMarginalLogLikelihood(self.model(x_batch), y_batch).iten())
